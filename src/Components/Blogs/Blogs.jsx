...
<section className="py-6 sm:py-12 ">
      <div className="container p-6 mx-auto space-y-8">
        ...
        <div className="grid grid-cols-1 gap-x-4 gap-y-8 md:grid-cols-2 lg:grid-cols-4">
          <article className="flex flex-col shadow-lg p-5">
            <a
            ...
            >
              <img
                ...
                src="https://res.cloudinary.com/dqescabbl/image/upload/v1723560545/stats-support_h98kjt.webp"
              />
            </a>
          ...
          <article className="flex flex-col shadow-lg p-5">
            ...
            >
              <img
                alt=""
                className="object-cover w-full h-52 "
                src="https://res.cloudinary.com/dqescabbl/image/upload/v1723560520/stats-secure-new_chajvw.webp"
              />
            </a>
            <div className="flex flex-col flex-1 p-6">
              <a
          ...
          <article className="flex flex-col shadow-lg p-5">
            ...
            >
              <img
                alt=""
                className="object-cover w-full h-52 "
                src="https://res.cloudinary.com/dqescabbl/image/upload/v1723560407/stats-reliable_tn0frd.webp"
              />
            </a>
            <div className="flex flex-col flex-1 p-6">
              <a
          ...
          <article className="flex flex-col shadow-lg p-5">
            ...
            >
              <img
                alt=""
                className="object-cover w-full h-52 "
                src="https://res.cloudinary.com/dqescabbl/image/upload/v1723560325/stats-scalable_a9xk14.webp"
              />
            </a>
            <div className="flex flex-col flex-1 p-6">
              <a
...
<div className="">
	<div className="container max-w-4xl px-10 py-6 mx-auto rounded-lg border-t-2 shadow-lg p-5 my-5">
		...
		<div className="flex items-center justify-between mt-4">
			<a rel="noopener noreferrer" href="#" className="hover:underline text-violet-400">Read more</a>
			<div>
				<a rel="noopener noreferrer" href="#" className="flex items-center">
					<img src="https://res.cloudinary.com/dqescabbl/image/upload/v1723377113/ananya-pandey-20240810142046_szygwo.webp" alt="avatar" className="object-cover w-10 h-10 mx-4 rounded-full bg-gray-500" />
